 ...
 * @author Zac
 */
public class CANSpeedController {
    ...
    private class CANTask extends TimerTask {
        ...
        private CANSpeedController m_controller;
        
        public CANTask(CANSpeedController controller) {
            if (controller == null) {
    ...
    public CANSpeedController (double Kp, double Ki, double Kd, CANJaguar jaguar, double period) {
        if(jaguar == null){
    ...
    public CANSpeedController (double Kp, double Ki, double Kd, CANJaguar jaguar) {
